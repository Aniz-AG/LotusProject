...
function DoublePana() {
  ...
  return (
    <>  
      ...
      <div className="font-bold flex items-center justify-center text-lg pt-2 underline"><h1>Double Pana</h1></div>
        <div className="flex justify-center items-center ">
          <div className="" style={cardStyle}>
            <input
              ...
              value={todayDate}
              readOnly
              className="shadow-md border w-full flex justify-center px-4 py-2 text-black font-bold border-black-500 rounded-xl text-center"
            />
            <p className="mt-2 text-white font-bold">Choose Session</p>
            ...
            <p className="mt-2 ml-2 text-white font-bold">{selectedOption === "open" ? "Open Pana" : "Close Pana"}</p>
            <input
              type="number"
              inputMode="numeric"
              ref={digit}
              placeholder="Enter Pana"
              className="shadow-md border w-full px-4 py-2  border-black-500 rounded-xl text-black font-bold"
            ...
            <div className="flex  mb-4 text-white">
              ...
              {isProceed && (
                <>
                  <button
                    className="px-4 py-2 border border-black-500 rounded-xl bg-yellow-600 hover:bg-yellow-500 cursor-pointer mt-4 w-full ml-3"
            ...
            {submittedData.map((data, index) => {
              ...
              return (
                <div key={index} className="w-full flex mb-3 ">
                  <div
                    className="shadow-md w-10/12  p-1  border border-greeen-700 bg-white text-black font-bold flex justify-between"
