...
function AddFunds() {
  const [selectedPaymentMethod, setSelectedPaymentMethod] = useState(null); // State to track payment method
    ...
    <>
      ...
      <div className="p-5" style={backStyle}>
        ...
        <div className="p-5 sm:w-auto md:max-w-lg lg:max-w-lg" style={box2}>
          ...
          <input type="text" placeholder="Enter amount" style={enterAmount} />
          <div style={gridContainer}>
            <button className="col-span-2" style={buttonStyle}>500</button>
            <button className="col-span-2" style={buttonStyle}>1000</button>
            <button className="col-span-2" style={buttonStyle}>2000</button>
            <button style={secondRowButtonStyle}>5000</button>
            <button style={secondRowButtonStyle}>10000</button>
          </div>
        </div>
          ...
          <div style={box3}>
            <label style={radioStyle}>
              <input
                ...
                style={radioInputStyle}
                name="radioGroup"
                onChange={() => setSelectedPaymentMethod("Others")}
              />
              <span className="ml-2" style={radioLabelStyle}>Others</span>
            </label>
          </div>
        </div>
        <div style={box4}>
          <button className="text-white rounded" style={btnStyle} onClick={handleAddMoney}>
            Add Money
          </button>
        </div>
        <h1 className="text-white mx-auto flex justify-center">Recent Transaction</h1>
