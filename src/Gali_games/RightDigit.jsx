...
function RightDigit() {
  ...
  return (
    <> 
      ...
      <div className="font-bold flex items-center justify-center text-lg pt-2 underline"><h1>Right Digit</h1></div>
        <div className="flex justify-center items-center ">
          <div className="" style={cardStyle}>
            <input
              ...
              value={todayDate}
              readOnly
              className="shadow-md w-full flex justify-center py-2 px-4 text-black border-2 rounded-xl text-center bg-white"
            />
            ...
            <input
              ...
              className="shadow-md w-full py-2 px-4 border rounded-xl text-black bg-white border-black-500"
    ...
    <option key={index} value={digit} />
            ...
            <div className="flex  mb-4 text-white">
              ...
              {isProceed && (
                  <>
                    <button
                      className="py-2 px-4 border border-black-500 rounded-xl bg-yellow-600 hover:bg-yellow-500 cursor-pointer text-black mt-4 w-full ml-3"
            ...
            {submittedData.map((data, index) => {
              ...
              return (
                <div key={index} className="w-full flex mb-3 ">
                  <div
                    className="shadow-md w-10/12  p-1  border border-black-500 bg-white border-black-500 text-black flex justify-between"
                  ...
                  <button
                    className="shadow-md bg-white border-black-500 py-2 px-4 flex items-center justify-center ml-1"
