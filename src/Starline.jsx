...
// // function Starline({ isStarline }) {  // Add the prop here
// //   const backStyle = {
...
// //             {isStarline && <p>This is the Starline component!</p>}
// //           </div>
// //         </div>
// //       </div>
// //     </>
...
function Starline({ isStarline }) {  // Accept the prop here
  const backStyle = {
    backgroundSize: "cover",
    paddingBottom: "30px",
  };
  ...
  // You can use the isStarline prop here to conditionally render or apply logic
  return (
    <>
      <div className="px-2">
        <div className="font-bold flex items-center justify-center text-lg mt-2 underline">
